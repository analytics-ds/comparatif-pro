---
title: "Facturation electronique et DGFiP : role de l'administration fiscale"
description: "Quel est le role de la DGFiP dans la facturation electronique ? PPF, AIFE, e-reporting, calendrier officiel, articulation avec les PDP, le tout decrypte."
slug: "facturation-electronique-dgfip"
date: "2026-05-07"
lastmod: "2026-05-07"
...
tags: ["facturation-electronique", "dgfip", "ppf", "aife", "e-reporting", "reforme-2026"]
image: "/images/blog/facturation-electronique-dgfip.jpg"
imageAlt: "Facade de la Direction generale des Finances publiques, pilote de la facturation electronique en France"
imageCredit: "Image issue d'Openverse (CC BY)"
faq:
  - question: "Quel est le role de la DGFiP dans la facturation electronique ?"
    answer: "La DGFiP pilote la reforme de la facturation electronique pour les transactions B2B en France. Elle definit les regles, supervise le PPF et l'immatriculation des PDP, et collecte les donnees de facturation et de paiement pour la TVA via l'e-reporting."
  - question: "Le PPF est-il gere par la DGFiP ?"
    answer: "Oui. Le Portail Public de Facturation est administre par la DGFiP, avec l'appui operationnel de l'AIFE qui gere deja Chorus Pro. Le PPF assure les fonctions d'annuaire des destinataires et de concentrateur des donnees fiscales."
  - question: "La DGFiP impose-t-elle un format de facture ?"
    answer: "La DGFiP autorise plusieurs formats conformes a la norme europeenne EN 16931, dont Factur-X, UBL et CII. Le choix du format reste libre tant qu'il est lisible par les plateformes et conforme aux specifications du socle technique publie sur impots.gouv.fr."
  - question: "Quand entre en vigueur l'obligation pilotee par la DGFiP ?"
    answer: "Selon le calendrier officiel publie par la DGFiP, la reception devient obligatoire au 1er septembre 2026 pour toutes les entreprises assujetties a la TVA. L'emission s'echelonne ensuite jusqu'au 1er septembre 2027 pour les TPE et micro-entrepreneurs."
---

> **En bref :**
> 1. La Direction generale des Finances publiques pilote la reforme et fixe le cadre reglementaire applicable a toutes les entreprises assujetties a la TVA.
> 2. Le Portail Public de Facturation, gere par la DGFiP avec l'appui de l'AIFE, joue le role d'annuaire central et de concentrateur des donnees fiscales.
> 3. L'e-reporting permet a la DGFiP de collecter en quasi temps reel les donnees de facturation et de paiement pour pre-remplir la TVA.
> 4. L'objectif affiche : reduire la fraude a la TVA, simplifier la vie des entreprises et generer une economie estimee a 4,5 milliards d'euros par an.
...
Pour comprendre la portee de cette reforme, il est utile de la replacer dans le [guide complet de la facturation electronique](/blog/guide-facturation-electronique/), qui detaille l'ensemble du dispositif.
...
Initialement, le PPF devait egalement offrir une fonction d'echange direct de factures entre entreprises (gratuite). Cette fonction de plateforme d'echange a ete recentree en 2024 sur le seul role d'annuaire et de concentrateur, afin de stabiliser le dispositif et de laisser les operations d'echange aux PDP privees. Pour bien comprendre [le role d'une plateforme de dematerialisation partenaire](/blog/pdp-facture-electronique/), il faut donc distinguer le PPF (public, central, gratuit pour ses fonctions residuelles) des PDP (privees, immatriculees, payantes).
...
> "La facturation electronique constitue une avancee majeure pour la modernisation de notre economie. Elle apportera des gains de productivite, simplifiera les obligations declaratives et permettra de mieux lutter contre la fraude a la TVA."
> -- Etude d'impact, ordonnance n 2021-1190, septembre 2021
...
Pour visualiser l'ensemble des etapes intermediaires (immatriculation des PDP, ouverture des bacs a sable, fin des periodes pilotes), il est utile de consulter le [calendrier de la facturation electronique](/blog/calendrier-facturation-electronique/) detaille par sous-periode.
...
<details>
<summary><strong>Quel est le role de la DGFiP dans la facturation electronique ?</strong></summary>
...
<details>
<summary><strong>Le PPF est-il gere par la DGFiP ?</strong></summary>
...
<details>
<summary><strong>La DGFiP impose-t-elle un format de facture ?</strong></summary>
...
<details>
<summary><strong>Quand entre en vigueur l'obligation pilotee par la DGFiP ?</strong></summary>
