...
Le perimetre couvre les prestations de services, les ventes de biens et les operations mixtes. Pour comprendre l'architecture globale du systeme et les acteurs en presence, ce [guide complet de la facturation electronique](/blog/guide-facturation-electronique/) replace la reforme dans son contexte legal.
...
> "L'obligation de facturation electronique s'applique a toutes les entreprises etablies en France assujetties a la TVA, quel que soit leur chiffre d'affaires, des lors qu'elles realisent des operations avec une autre entreprise assujettie."
> -- DGFiP, page "La facturation electronique" sur impots.gouv.fr, 2026
...
Pour un comparatif plus large couvrant aussi les TPE et PME, le [meilleur logiciel de facturation electronique](/blog/meilleur-logiciel-facturation-electronique/) en 2026 detaille les solutions positionnees au-dessus de la cible micro-entrepreneur. Pour les structures qui depassent la micro-entreprise et basculent en regime reel, la [facture electronique pour TPE](/blog/facture-electronique-tpe/) examine les options dimensionnees pour les volumes superieurs.
...
| Outil | Modele | Statut PDP (DGFiP) | Format Factur-X | Cible ideale |
|---|---|---|---|---|
| **Henrri** | Gratuit (Rivalis) | Dossier d'immatriculation depose | Oui | Micro-entrepreneur prestataires de services |
| **Facture.net** | Gratuit (Cegid) | Routage via Cegid (PDP groupe) | Oui | Auto-entrepreneurs commerce et artisanat |
| **Indy** | Freemium (gratuit basique) | Dossier d'immatriculation depose | Oui | Professions liberales, BNC |
| **Tiime** | Freemium (offre micro) | Dossier d'immatriculation depose | Oui | Auto-entrepreneurs accompagnes par un cabinet |
...
> "Les editeurs de logiciels de facturation jouent un role central dans la mise en conformite des micro-entrepreneurs. Le choix d'un outil immatricule comme PDP, ou rattache a une PDP du groupe, simplifie considerablement la phase d'emission a partir de septembre 2027."
> -- AIFE, Agence pour l'Informatique Financiere de l'Etat, communique technique 2026
...
Un auto-entrepreneur dont l'activite croit et qui depasse les seuils de franchise (39 100 euros pour les services en 2025-2026, 91 900 euros pour les ventes de biens) doit anticiper le passage en regime reel de TVA. Le [statut d'auto-entrepreneur face a la reforme](/blog/facturation-electronique-obligatoire/) et les obligations qui en decoulent sont synthetises dans le contenu sur l'obligation de facturation electronique. La mise en place d'un outil prenant en charge la TVA des l'origine evite une migration penible au moment du basculement.
...
- Reception obligatoire au 1er septembre 2026, emission au 1er septembre 2027 pour les TPE et micro. Le calendrier des [echeances de la reforme](/blog/calendrier-facturation-electronique/) reprend l'ensemble des dates par type d'entreprise.
...
<details>
<summary><strong>Un auto-entrepreneur est-il concerne par la facturation electronique ?</strong></summary>
...
<details>
<summary><strong>Quelles mentions un auto-entrepreneur en franchise de TVA doit-il porter sur sa facture ?</strong></summary>
...
<details>
<summary><strong>Quel outil gratuit choisir pour passer a la facture electronique en micro-entreprise ?</strong></summary>
...
<details>
<summary><strong>Faut-il s'inscrire au Portail Public de Facturation pour facturer en electronique ?</strong></summary>
