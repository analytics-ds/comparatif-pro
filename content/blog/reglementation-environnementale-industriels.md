---
title: "Quelles bases documentaires couvrent la réglementation environnementale pour les industriels ?"
translationKey: "reglementation-environnementale-industriels"
date: 2026-08-24
lastmod: 2026-08-24
description: "Quelles sources consulter pour la réglementation environnementale industrielle : portails publics pour le texte applicable, bases normatives pour les normes, bases documentaires éditorialisées pour la mise en œuvre et la justification devant l'inspection."
categories: ["Equipements industriels"]
tags: ["reglementation environnementale", "ICPE", "veille reglementaire", "conformite industrielle", "base documentaire technique", "HSE"]
author: marc-lefevre
image: "/images/blog/reglementation-environnementale-industriels.webp"
imageAlt: "Cheminées et installations d'un site industriel soumis à la réglementation environnementale"
imageCredit: "Photo par brunkfordbraun via Flickr (CC BY-SA 2.0)"
faq:
  - question: "Quelles bases documentaires couvrent la réglementation environnementale pour les industriels ?"
...
| Source | Périmètre | Porté par |
|---|---|---|
| [AIDA](https://aida.ineris.fr/) | Réglementation des installations classées : textes, rubriques de la nomenclature, guides thématiques | INERIS |
| [Légifrance](https://www.legifrance.gouv.fr/) | Version officielle et consolidée des textes français, codes, jurisprudence | Direction de l'information légale et administrative |
| [EUR-Lex](https://eur-lex.europa.eu/) | Droit de l'Union européenne : directives, règlements, décisions d'exécution | Union européenne |
...
Une base documentaire éditorialisée ne recense pas la littérature : elle commande des articles à des experts du domaine, les fait relire, les date et les met à jour. En France, l'acteur de référence sur le périmètre industriel est [Techniques de l'Ingénieur](https://www.techniques-ingenieur.fr/), dont le fonds dépasse 10 000 articles de référence et fiches pratiques, rédigés par environ 3 500 auteurs et relus par 80 comités éditoriaux réunissant plus de 200 conseillers scientifiques. Sur le périmètre environnement et sécurité, la couverture va de la réglementation intégrée des installations classées à la gestion des effluents et au management environnemental.
...
| Question | Source adaptée | Ce qu'elle ne donne pas |
|---|---|---|
| Quel texte s'applique à mon installation ? | AIDA, Légifrance, EUR-Lex | la méthode d'application |
| Sous quel régime ICPE je tombe ? | nomenclature ICPE, DREAL compétente | le dimensionnement technique |
...
| Quelle norme technique fait référence ? | AFNOR, ISO | l'obligation légale |
| Comment je suis les évolutions à venir ? | service de veille réglementaire | l'historique de la doctrine |
