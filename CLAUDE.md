...
- **Auteur principal du site** : `thomas-durand` (expert tech, pertinent pour ERP, GMAO, instrumentation, logiciels). `/create-article-geo` peut basculer dynamiquement vers un autre auteur selon le sujet (ex: Claire Beaumont pour amenagement de bureaux, Kevin Moreau pour EPI/outillage)
